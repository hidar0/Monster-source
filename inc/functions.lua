...
download_file('https://raw.githubusercontent.com/hidar0/Monster/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/hidar0/Monster/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/hidar0/Monster/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/hidar0/Monster/master/inc/functions.lua','./inc/functions.lua')
...
usernn = data.username_ or "hidar0"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "hidar0"
end
Name = Name:gsub('[[][]]','')
...
message = message ..i.. '-l ['..info.username..'](t.me/SouurceLink) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/SouurceLink) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/SouurceLink) l » (`' ..v.. '`) \n'
end
end
end
